...
class HtmlReporter:
    """Generate an HTML-formatted audit report from a witness log session.
    ...
    def load_events(self) -> list[dict]:
        ...
        """
        raise NotImplementedError("HtmlReporter.load_events is not yet implemented")
    ...
    def generate(self) -> str:
        ...
        .. note::
            Not yet fully implemented.
        """
        raise NotImplementedError("HtmlReporter.generate is not yet implemented")
